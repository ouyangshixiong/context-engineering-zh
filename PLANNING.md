# 🤖 规划代理专用规范（Planning Agent Specification）

> **规划代理行为准则** - 15分钟Think Hard方法论的标准化实施规范，确保每个技术决策都有据可依。
...
graph TD
    subgraph 规划代理输入
        CREATE[CREATE.md需求] --> PLAN[规划代理<br/>15分钟分析]
    end
...
#### 技术规格模板（INITIAL.md格式）
基于CREATE.md、ML.md、TASK.md的规范引用，规划代理必须输出：
