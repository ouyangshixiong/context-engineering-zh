...
### 📊 时间分配精确规范
| 思考阶段 | 时间分配 | 规范引用位置 | 决策产出 | 验证标准 |
|----------|----------|--------------|----------|----------|
| **需求澄清** | 5分钟 | CREATE.md第4章 | 需求定义文档 | 问题-场景-标准三元组 |
| **技术评估** | 4分钟 | ML.md第1章矩阵 | 技术选型方案 | 量化评分≥3.5分 |
| **资源规划** | 3分钟 | ML.md第2章需求 | 资源配置计划 | GPU内存精确计算 |
| **时间设计** | 3分钟 | TASK.md第4章 | 项目里程碑 | 甘特图可视化 |
...
#### 技术规格模板（INITIAL.md格式）
基于CREATE.md、ML.md、TASK.md的规范引用，规划自主编程智能体必须输出：
